...
CVar::CVar( LocalRegistry& lr, const GR::String& Name, const GR::String& Value ) :
  m_Name( Name ),
  m_pRegistry( &lr ),
  m_Temporary( false )
{
...
CVar& CVar::operator =( const GR::String &Input )
{ 
...
CVar& CVar::operator =( const float Input )
{ 
...
CVar& CVar::operator =( const int& Input )
{ 
