...
class CGameObject : public ICloneAble, public IUpdateAble<float>, public IEventListener<tObjectEvent>
{
  ...
  public:
    ...
    math::tRect<int>      m_vColissionRect;

    tAnimationPos         m_animPos;

    tTriggerArea*         m_pCurrentTrigger;

    GR::GAME::tPathPos    m_pathPos;
    ...
    virtual void          Render( CD3DViewer& Viewer, const D3DXVECTOR3& vectOffset, size_t iTile );

    GR::tRect             ColissionRect();
