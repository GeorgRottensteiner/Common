...
void CColoredButton::SetColor( DWORD dwColor )
{

  m_rgbBackground         = RGB( ( dwColor & 0xff0000 ) >> 16, ( dwColor & 0xff00 ) >> 8, ( dwColor & 0xff ) );
  Invalidate();
...
void CColoredButton::OnSetFocus(CWnd* pOldWnd)
{
