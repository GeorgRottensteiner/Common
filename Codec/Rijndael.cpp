...
namespace GR
{
  namespace Codec
  {
      ...
      m_NumRounds( 0 )
    {
      ...
      memset( m_ExpandedKey, 0, sizeof( m_ExpandedKey ) );
    }



    int Rijndael::init( Mode Mode, bool Encrypt, const GR::u8* pKey, int KeyLength, GR::u8* pInitVector )
    {
      m_StateValid = false;
      ...
      &&   ( KeyLength != 32 ) )
      {
        return RES_UNSUPPORTED_KEY_LENGTH;
      }
      if ( !pKey )
      {
        return RES_BAD_KEY;
      ...
      if ( pInitVector )
      {
        memcpy( m_InitVector, pInitVector, MAX_IV_SIZE );
      }
      else
      {
        memset( m_InitVector, 0, sizeof( m_InitVector ) );
      ...
      m_NumRounds = ( KeyLength * 8 / 32 ) + 6;

      GR::u8 keyMatrix[MAX_KEY_COLUMNS][4];

      for ( int i = 0; i < KeyLength; i++ )
      {
        keyMatrix[i >> 2][i & 3] = pKey[i];
      }
    ...
    int Rijndael::BlockEncrypt( const GR::u8* pInputData, int InputLength, GR::u8* pOutBuffer )
    {
      int       numBlocks;
      ...
      switch ( m_Mode )
      {
        ...
        case Mode::CBC:
          ...
          ( (GR::u32*)block )[3] = ( (GR::u32*)m_InitVector )[3] ^ ( (GR::u32*)pInputData )[3];
          encrypt( block, pOutBuffer );
          pInputData += 16;
          for ( int i = numBlocks - 1; i > 0; i-- )
          {
            ( (GR::u32*)block )[0] = ( (GR::u32*)pOutBuffer )[0] ^ ( (GR::u32*)pInputData )[0];
            ( (GR::u32*)block )[1] = ( (GR::u32*)pOutBuffer )[1] ^ ( (GR::u32*)pInputData )[1];
            ( (GR::u32*)block )[2] = ( (GR::u32*)pOutBuffer )[2] ^ ( (GR::u32*)pInputData )[2];
            ( (GR::u32*)block )[3] = ( (GR::u32*)pOutBuffer )[3] ^ ( (GR::u32*)pInputData )[3];
            pOutBuffer += 16;
            encrypt( block, pOutBuffer );
            pInputData += 16;
          }
    ...
    #else  
          *( (GR::u32*)iv[0] ) = *( (GR::u32*)( m_InitVector     ) );
          *( (GR::u32*)iv[1] ) = *( (GR::u32*)( m_InitVector + 4 ) );
          *( (GR::u32*)iv[2] ) = *( (GR::u32*)( m_InitVector + 8 ) );
          *( (GR::u32*)iv[3] ) = *( (GR::u32*)( m_InitVector +12 ) );
    #endif 
          for ( int i = numBlocks; i > 0; i-- )
          {
            for ( int k = 0; k < 128; k++ )
            {
              *( (GR::u32*)  block     ) = *( (GR::u32*)iv[0] );
              *( (GR::u32*)( block+ 4 )) = *( (GR::u32*)iv[1] );
              *( (GR::u32*)( block+ 8 )) = *( (GR::u32*)iv[2] );
              *( (GR::u32*)( block+12 )) = *( (GR::u32*)iv[3] );
              encrypt( block, block );
              pOutBuffer[k/8] ^= ( block[0] & 0x80 ) >> ( k & 7 );
              iv[0][0] = (GR::u8)( ( iv[0][0] << 1 ) | ( iv[0][1] >> 7 ) );
              iv[0][1] = (GR::u8)( ( iv[0][1] << 1 ) | ( iv[0][2] >> 7 ) );
              iv[0][2] = (GR::u8)( ( iv[0][2] << 1 ) | ( iv[0][3] >> 7 ) );
              iv[0][3] = (GR::u8)( ( iv[0][3] << 1 ) | ( iv[1][0] >> 7 ) );
              iv[1][0] = (GR::u8)( ( iv[1][0] << 1 ) | ( iv[1][1] >> 7 ) );
              iv[1][1] = (GR::u8)( ( iv[1][1] << 1 ) | ( iv[1][2] >> 7 ) );
              iv[1][2] = (GR::u8)( ( iv[1][2] << 1 ) | ( iv[1][3] >> 7 ) );
              iv[1][3] = (GR::u8)( ( iv[1][3] << 1 ) | ( iv[2][0] >> 7 ) );
              iv[2][0] = (GR::u8)( ( iv[2][0] << 1 ) | ( iv[2][1] >> 7 ) );
              iv[2][1] = (GR::u8)( ( iv[2][1] << 1 ) | ( iv[2][2] >> 7 ) );
              iv[2][2] = (GR::u8)( ( iv[2][2] << 1 ) | ( iv[2][3] >> 7 ) );
              iv[2][3] = (GR::u8)( ( iv[2][3] << 1 ) | ( iv[3][0] >> 7 ) );
              iv[3][0] = (GR::u8)( ( iv[3][0] << 1 ) | ( iv[3][1] >> 7 ) );
              iv[3][1] = (GR::u8)( ( iv[3][1] << 1 ) | ( iv[3][2] >> 7 ) );
              iv[3][2] = (GR::u8)( ( iv[3][2] << 1 ) | ( iv[3][3] >> 7 ) );
              iv[3][3] = (GR::u8)( ( iv[3][3] << 1 ) | ( pOutBuffer[k/8] >> ( 7 - ( k & 7 ) ) ) & 1 );
            }
          }
          break;
        default:
    ...
    int Rijndael::EncryptPadded( const GR::u8* pInput, int InputLength, GR::u8* pOutBuffer )
    {
      int       numBlocks, 
                padLen;
      ...
      switch ( m_Mode )
      {
        case Mode::ECB:
          ...
          padLen = 16 - ( InputLength - 16 * numBlocks );
        ...
        case Mode::CBC:
          ...
          for ( int i = numBlocks; i > 0; i-- )
          {
            ( (GR::u32*)block )[0] = ( (GR::u32*)pInput )[0] ^ ( (GR::u32*)iv )[0];
            ( (GR::u32*)block )[1] = ( (GR::u32*)pInput )[1] ^ ( (GR::u32*)iv )[1];
            ( (GR::u32*)block )[2] = ( (GR::u32*)pInput )[2] ^ ( (GR::u32*)iv )[2];
            ( (GR::u32*)block )[3] = ( (GR::u32*)pInput )[3] ^ ( (GR::u32*)iv )[3];
            encrypt( block, pOutBuffer );
            iv = pOutBuffer;
            pInput      += 16;
            pOutBuffer  += 16;
          ...
          {
            block[i] = (GR::u8)( pInput[i] ^ iv[i] );
          }
          for ( int i = 16 - padLen; i < 16; i++ ) 
          {
            block[i] = (GR::u8)( padLen ^ iv[i] );
          }
          encrypt( block, pOutBuffer );
          break;
        default:
    ...
    int Rijndael::BlockDecrypt( const GR::u8* pInput, int InputLength, GR::u8* pOutBuffer )
    {
      int     numBlocks;
      GR::u8  block[16], 
              iv[4][4];
      ...
      switch ( m_Mode )
      {
        ...
        case Mode::CBC:
          ...
          *( (GR::u32*)iv[3] ) = *( (GR::u32*)( m_InitVector +12 ) );
          ...
          for ( int i = numBlocks; i > 0; i--)
          {
            decrypt(pInput, block);
            ( (GR::u32*)block )[0] ^= *( (GR::u32*)iv[0] );
            ( (GR::u32*)block )[1] ^= *( (GR::u32*)iv[1] );
            ( (GR::u32*)block )[2] ^= *( (GR::u32*)iv[2] );
            ( (GR::u32*)block )[3] ^= *( (GR::u32*)iv[3] );
    #if STRICT_ALIGN
            memcpy(iv, input, 16);
            memcpy(outBuf, block, 16);
    #else
            *( (GR::u32*)iv[0] ) = ( (GR::u32*)pInput )[0]; ( (GR::u32*)pOutBuffer )[0] = ( (GR::u32*)block )[0];
            *( (GR::u32*)iv[1] ) = ( (GR::u32*)pInput )[1]; ( (GR::u32*)pOutBuffer )[1] = ( (GR::u32*)block )[1];
            *( (GR::u32*)iv[2] ) = ( (GR::u32*)pInput )[2]; ( (GR::u32*)pOutBuffer )[2] = ( (GR::u32*)block )[2];
            *( (GR::u32*)iv[3] ) = ( (GR::u32*)pInput )[3]; ( (GR::u32*)pOutBuffer )[3] = ( (GR::u32*)block )[3];
    #endif
            pInput += 16;
            pOutBuffer += 16;
          }
          ...
          for ( int i = numBlocks; i > 0; i-- )
          {
            for ( int k = 0; k < 128; k++ )
            {
              ...
              *( (GR::u32*)( block+12 ) ) = *( (GR::u32*)iv[3] );
              ...
              iv[3][1] = (GR::u8)( ( iv[3][1] << 1 ) | ( iv[3][2] >> 7 ) );
              iv[3][2] = (GR::u8)( ( iv[3][2] << 1 ) | ( iv[3][3] >> 7 ) );
              iv[3][3] = (GR::u8)( ( iv[3][3] << 1 ) | ( pInput[k / 8] >> ( 7 - ( k & 7 ) ) ) & 1 );
              pOutBuffer[k / 8] ^= ( block[0] & 0x80 ) >> ( k & 7 );
            }
          }
          break;
    ...
    int Rijndael::padDecrypt( const GR::u8* pInput, int InputLength, GR::u8* pOutBuffer )
    {
      int     numBlocks, 
              padLen;
      GR::u8  block[16];
    ...
    void Rijndael::keySched( GR::u8 key[MAX_KEY_COLUMNS][4] )
    {
      int     rconpointer = 0;
      ...
      int uKeyColumns = (int)m_NumRounds - 6;

      GR::u8 tempKey[MAX_KEY_COLUMNS][4];

      // Copy the input key to the temporary key matrix
      for ( int j = 0; j < uKeyColumns; j++ )
      {
        *( (GR::u32*)( tempKey[j] ) ) = *( (GR::u32*)( key[j] ) );
      }
      ...
      for ( int j = 0; ( j < uKeyColumns ) && ( r <= m_NumRounds ); )
      {
        for ( ; ( j < uKeyColumns ) && ( t < 4 ); j++, t++ )
        {
          *( (GR::u32*)m_ExpandedKey[r][t] ) = *( (GR::u32*)tempKey[j] );
        }
      ...
      while ( r <= m_NumRounds )
      {
        ...
        if ( uKeyColumns != 8 )
        {
          ...
          {
            *( (GR::u32*)tempKey[j] ) ^= *( (GR::u32*)tempKey[j - 1] );
          }
        } 
        else 
        {
    ...
    void Rijndael::keyEncToDec()
    {
      ...
      for ( GR::u32 r = 1; r < m_NumRounds; r++ )
      {
        pKeyQuad = m_ExpandedKey[r][0];
        *( (GR::u32*)pKeyQuad ) = *( (GR::u32*)U1[pKeyQuad[0]] ) ^ *( (GR::u32*)U2[pKeyQuad[1]] ) ^ *( (GR::u32*)U3[pKeyQuad[2]] ) ^ *( (GR::u32*)U4[pKeyQuad[3]] );
        pKeyQuad = m_ExpandedKey[r][1];
        *( (GR::u32*)pKeyQuad ) = *( (GR::u32*)U1[pKeyQuad[0]] ) ^ *( (GR::u32*)U2[pKeyQuad[1]] ) ^ *( (GR::u32*)U3[pKeyQuad[2]] ) ^ *( (GR::u32*)U4[pKeyQuad[3]] );
        pKeyQuad = m_ExpandedKey[r][2];
        *( (GR::u32*)pKeyQuad ) = *( (GR::u32*)U1[pKeyQuad[0]] ) ^ *( (GR::u32*)U2[pKeyQuad[1]] ) ^ *( (GR::u32*)U3[pKeyQuad[2]] ) ^ *( (GR::u32*)U4[pKeyQuad[3]] );
        pKeyQuad = m_ExpandedKey[r][3];
        *( (GR::u32*)pKeyQuad ) = *( (GR::u32*)U1[pKeyQuad[0]] ) ^ *( (GR::u32*)U2[pKeyQuad[1]] ) ^ *( (GR::u32*)U3[pKeyQuad[2]] ) ^ *( (GR::u32*)U4[pKeyQuad[3]] );
      }
    }
    ...
    void Rijndael::encrypt( const GR::u8 a[16], GR::u8 b[16] )
    {
      GR::u8  temp[4][4];

      *( (GR::u32*)temp[0] )    = *( (GR::u32*)( a     ) ) ^ *( (GR::u32*)m_ExpandedKey[0][0] );
      *( (GR::u32*)temp[1] )    = *( (GR::u32*)( a + 4 ) ) ^ *( (GR::u32*)m_ExpandedKey[0][1] );
      *( (GR::u32*)temp[2] )    = *( (GR::u32*)( a + 8 ) ) ^ *( (GR::u32*)m_ExpandedKey[0][2] );
      *( (GR::u32*)temp[3] )    = *( (GR::u32*)( a +12 ) ) ^ *( (GR::u32*)m_ExpandedKey[0][3] );
      *( (GR::u32*)( b    ) )   = *( (GR::u32*)T1[temp[0][0]] )
                                ^ *( (GR::u32*)T2[temp[1][1]] )
                                ^ *( (GR::u32*)T3[temp[2][2]] )
                                ^ *( (GR::u32*)T4[temp[3][3]] );
      *( (GR::u32* )( b + 4 ) ) = *( (GR::u32*)T1[temp[1][0]] )
                                ^ *( (GR::u32*)T2[temp[2][1]] )
                                ^ *( (GR::u32*)T3[temp[3][2]] )
                                ^ *( (GR::u32*)T4[temp[0][3]] );
      *( (GR::u32*)( b + 8 ) )  = *( (GR::u32*)T1[temp[2][0]] )
                                ^ *( (GR::u32*)T2[temp[3][1]] )
                                ^ *( (GR::u32*)T3[temp[0][2]] )
                                ^ *( (GR::u32*)T4[temp[1][3]] );
      *( (GR::u32*)( b + 12 ) ) = *( (GR::u32*)T1[temp[3][0]] )
                                ^ *( (GR::u32*)T2[temp[0][1]] )
                                ^ *( (GR::u32*)T3[temp[1][2]] )
                                ^ *( (GR::u32*)T4[temp[2][3]] );
      for ( GR::u32 r = 1; r < m_NumRounds - 1; r++ )
      {
        *( (GR::u32*)temp[0] ) = *( (GR::u32*)( b     ) ) ^ *( (GR::u32*)m_ExpandedKey[r][0] );
        *( (GR::u32*)temp[1] ) = *( (GR::u32*)( b + 4 ) ) ^ *( (GR::u32*)m_ExpandedKey[r][1] );
        *( (GR::u32*)temp[2] ) = *( (GR::u32*)( b + 8 ) ) ^ *( (GR::u32*)m_ExpandedKey[r][2] );
        *( (GR::u32*)temp[3] ) = *( (GR::u32*)( b +12 ) ) ^ *( (GR::u32*)m_ExpandedKey[r][3] );
      ...
      *( (GR::u32*)temp[0] ) = *( (GR::u32*)( b     ) ) ^ *( (GR::u32*)m_ExpandedKey[m_NumRounds - 1][0] );
      *( (GR::u32*)temp[1] ) = *( (GR::u32*)( b + 4 ) ) ^ *( (GR::u32*)m_ExpandedKey[m_NumRounds - 1][1] );
      *( (GR::u32*)temp[2] ) = *( (GR::u32*)( b + 8 ) ) ^ *( (GR::u32*)m_ExpandedKey[m_NumRounds - 1][2] );
      *( (GR::u32*)temp[3] ) = *( (GR::u32*)( b +12 ) ) ^ *( (GR::u32*)m_ExpandedKey[m_NumRounds - 1][3] );
      b[ 0] = T1[temp[0][0]][1];
      b[ 1] = T1[temp[1][1]][1];
      b[ 2] = T1[temp[2][2]][1];
      b[ 3] = T1[temp[3][3]][1];
      ...
      b[14] = T1[temp[1][2]][1];
      b[15] = T1[temp[2][3]][1];
      *( (GR::u32*)( b     ) ) ^= *( (GR::u32*)m_ExpandedKey[m_NumRounds][0] );
      *( (GR::u32*)( b + 4 ) ) ^= *( (GR::u32*)m_ExpandedKey[m_NumRounds][1] );
      *( (GR::u32*)( b + 8 ) ) ^= *( (GR::u32*)m_ExpandedKey[m_NumRounds][2] );
      *( (GR::u32*)( b +12 ) ) ^= *( (GR::u32*)m_ExpandedKey[m_NumRounds][3] );
    }



    void Rijndael::decrypt( const GR::u8 a[16], GR::u8 b[16] )
    {
      GR::u8 temp[4][4];

      *( (GR::u32*)temp[0] ) = *( (GR::u32*)( a     ) ) ^ *( (GR::u32*)m_ExpandedKey[m_NumRounds][0] );
      *( (GR::u32*)temp[1] ) = *( (GR::u32*)( a + 4 ) ) ^ *( (GR::u32*)m_ExpandedKey[m_NumRounds][1] );
      *( (GR::u32*)temp[2] ) = *( (GR::u32*)( a + 8 ) ) ^ *( (GR::u32*)m_ExpandedKey[m_NumRounds][2] );
      *( (GR::u32*)temp[3] ) = *( (GR::u32*)( a +12 ) ) ^ *( (GR::u32*)m_ExpandedKey[m_NumRounds][3] );

      *( (GR::u32*)( b   ) )    = *( (GR::u32*)T5[temp[0][0]] )
                                ^ *( (GR::u32*)T6[temp[3][1]] )
                                ^ *( (GR::u32*)T7[temp[2][2]] )
                                ^ *( (GR::u32*)T8[temp[1][3]] );
      *( (GR::u32*)( b + 4 ) )  = *( (GR::u32*)T5[temp[1][0]] )
                                ^ *( (GR::u32*)T6[temp[0][1]] )
                                ^ *( (GR::u32*)T7[temp[3][2]] )
                                ^ *( (GR::u32*)T8[temp[2][3]] );
      *( (GR::u32*)( b + 8 ) )  = *( (GR::u32*)T5[temp[2][0]] )
                                ^ *( (GR::u32*)T6[temp[1][1]] )
                                ^ *( (GR::u32*)T7[temp[0][2]] )
                                ^ *( (GR::u32*)T8[temp[3][3]] );
      *( (GR::u32*)( b + 12 ) ) = *( (GR::u32*)T5[temp[3][0]] )
                                ^ *( (GR::u32*)T6[temp[2][1]] )
                                ^ *( (GR::u32*)T7[temp[1][2]] )
                                ^ *( (GR::u32*)T8[temp[0][3]] );
      for ( GR::u32 r = m_NumRounds - 1; r > 1; r-- )
      {
        *( (GR::u32*)temp[0] )    = *( (GR::u32*)( b     ) ) ^ *( (GR::u32*)m_ExpandedKey[r][0] );
        *( (GR::u32*)temp[1] )    = *( (GR::u32*)( b + 4 ) ) ^ *( (GR::u32*)m_ExpandedKey[r][1] );
        *( (GR::u32*)temp[2] )    = *( (GR::u32*)( b + 8 ) ) ^ *( (GR::u32*)m_ExpandedKey[r][2] );
      ...
      *( (GR::u32*)temp[0] ) = *( (GR::u32*)( b      ) ) ^ *( (GR::u32*)m_ExpandedKey[1][0] );
      *( (GR::u32*)temp[1] ) = *( (GR::u32*)( b +  4 ) ) ^ *( (GR::u32*)m_ExpandedKey[1][1] );
      *( (GR::u32*)temp[2] ) = *( (GR::u32*)( b +  8 ) ) ^ *( (GR::u32*)m_ExpandedKey[1][2] );
      *( (GR::u32*)temp[3] ) = *( (GR::u32*)( b + 12 ) ) ^ *( (GR::u32*)m_ExpandedKey[1][3] );
      b[ 0] = S5[temp[0][0]];
      b[ 1] = S5[temp[3][1]];
      b[ 2] = S5[temp[2][2]];
      b[ 3] = S5[temp[1][3]];
      ...
      b[14] = S5[temp[1][2]];
      b[15] = S5[temp[0][3]];
      *( (GR::u32*)( b     ) ) ^= *( (GR::u32*)m_ExpandedKey[0][0] );
      *( (GR::u32*)( b + 4 ) ) ^= *( (GR::u32*)m_ExpandedKey[0][1] );
      *( (GR::u32*)( b + 8 ) ) ^= *( (GR::u32*)m_ExpandedKey[0][2] );
      *( (GR::u32*)( b +12 ) ) ^= *( (GR::u32*)m_ExpandedKey[0][3] );
    }



    ByteBuffer Rijndael::Encrypt( const ByteBuffer& Key, const ByteBuffer& InitialisationVector, const ByteBuffer& Data )
    {
    ...
    ByteBuffer Rijndael::Decrypt( const ByteBuffer& Key, const ByteBuffer& InitialisationVector, const ByteBuffer& Data )
    {
      ByteBuffer result( Data.Size() );
    ...
    bool Rijndael::Initialise( Mode Mode, bool Encrypt, const ByteBuffer& Key, const ByteBuffer& InitialisationVector )
    {
      return init( Mode, Encrypt, (const GR::u8*)Key.Data(), (int)Key.Size() ) == RES_SUCCESS;
    }
    ...
    bool Rijndael::TransformBlock( const ByteBuffer& Data, ByteBuffer& Target, GR::u32 NumOfBytes )
    {
      if ( NumOfBytes == 0 )
      {
        NumOfBytes = (GR::u32)Data.Size();
      }
      if ( NumOfBytes > Data.Size() )
      {
        return false;
      }
      if ( m_CachedInputData.Size() + Data.Size() < 16 )
      {
        m_CachedInputData += Data;
        Target.Clear();
        return true;
      }
      ...
      if ( processData.Size() % 16 )
      {
        ...
        processData.Resize( ( processData.Size() / 16 ) * 16 );
        NumOfBytes        = processData.Size();
      }
      if ( Target.Size() < NumOfBytes / 8 )
      {
        Target.Resize( NumOfBytes / 8 );
        return false;
      }
      if ( m_Encrypt )
      {
        BlockEncrypt( (GR::u8*)processData.Data(), NumOfBytes, (GR::u8*)Target.Data() );
      }
      else
      {
        BlockDecrypt( (GR::u8*)processData.Data(), NumOfBytes, (GR::u8*)Target.Data() );
      }
      return true;
    }
    ...
    ByteBuffer Rijndael::TransformFinalBlock( const ByteBuffer& Data )
    {
      m_CachedInputData += Data;

      ByteBuffer   result( m_CachedInputData.Size() );
      if ( m_Encrypt )
      {
        BlockEncrypt( (GR::u8*)m_CachedInputData.Data(), (int)m_CachedInputData.Size(), (GR::u8*)result.Data() );
      }
      else
      {
        BlockDecrypt( (GR::u8*)m_CachedInputData.Data(), (int)m_CachedInputData.Size(), (GR::u8*)result.Data() );
      }
      m_CachedInputData.Clear();
      return result;
    }



    bool Rijndael::EncryptCBC( const ByteBuffer& In, const ByteBuffer& Key, ByteBuffer& Encrypted, const ByteBuffer& IV )
    {
      Encrypted.Resize( In.Size() );
    ...
    bool Rijndael::DecryptCBC( const ByteBuffer& In, const ByteBuffer& Key, ByteBuffer& Decrypted, const ByteBuffer& IV )
    {
      Decrypted.Resize( In.Size() );
    ...
    ByteBuffer Rijndael::EncryptECB( const ByteBuffer& Key, const ByteBuffer& InitialisationVector, const ByteBuffer& Data )
    {
      ByteBuffer    result( Data.Size() );
    ...
    ByteBuffer Rijndael::DecryptECB( const ByteBuffer& Key, const ByteBuffer& InitialisationVector, const ByteBuffer& Data )
    {
      ByteBuffer result( Data.Size() );
