...
#ifndef XTREME_DX11_VERTEXBUFFER_H
#define XTREME_DX11_VERTEXBUFFER_H
...
class DX11VertexBuffer : public XBasicVertexBuffer
{
  ...
  public:
    ...
    DX11VertexBuffer( XRenderer* pRenderClass );
...
#endif // XTREME_DX11_VERTEXBUFFER_H