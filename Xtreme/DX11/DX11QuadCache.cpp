...
void DX11QuadCache::VertexEntry::SetColor( GR::u32 Color )
{
  // R
...
DX11QuadCache::DX11QuadCache( DX11Renderer* pRenderer, GR::u32 VertexFormat ) :
  m_pBuffer( NULL ),
...
void DX11QuadCache::AddEntry( const XTextureSection& Section, const GR::tVector& Pos, const GR::tVector& Size, GR::u32 Color,
...
void DX11QuadCache::AddEntry( XTexture* pTexture,
...
void DX11QuadCache::EnsureBuffer()
{
  if ( m_pBuffer != NULL )
  {
    return;
...
void DX11QuadCache::DrawPart( int StartPrimitive, int PrimitiveCount )
{
...
void DX11QuadCache::TransformChanged( XRenderer::eTransformType TransformType )
{
