...
struct tD3DDeviceInfo
{
    ...
    std::vector<tD3D9ModeInfo>  m_vectMode;
...
class CDX9RenderClass : public XBasicRenderer
{

  public:


    CDX9RenderClass( HINSTANCE hInstance = NULL );
    virtual ~CDX9RenderClass();
  ...
  protected:
    ...
    tD3D9ModeInfo*                m_pCurrentModeInfo;


    void                          CheckAdapterMode( tD3DAdapterInfo& Adapter, int iAdapter, D3DFORMAT d3dFmt );
    ...
    static CDX9RenderClass*       g_pDX9Instance;

    static LRESULT CALLBACK       DX9Proc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam );
