...
class CDX9VertexBuffer : public XBasicVertexBuffer
{

  protected:

    typedef std::vector<IDirect3DVertexBuffer9*>    tVectVertexBuffers;
    ...
    bool                          CreateBuffers( LPDIRECT3DDEVICE9 pd3dDevice );
    void                          Invalidate();
  ...
  public:
    ...
    CDX9VertexBuffer( XRenderer* pRenderClass );
