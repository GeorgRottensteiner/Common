...
void VulkanLineCache::VertexEntry::SetColor( GR::u32 Color )
{
  // R
...
VulkanLineCache::VulkanLineCache( VulkanRenderer* pRenderer, GR::u32 VertexFormat ) :
  m_pBuffer( NULL ),
...
void VulkanLineCache::AddEntry( XTexture* pTexture, const GR::tVector& Pos1, const GR::tVector& Pos2, GR::u32 Color,
...
void VulkanLineCache::AddEntry( XTexture* pTexture,
...
void VulkanLineCache::EnsureBuffer()
{
  if ( m_pBuffer != NULL )
  {
    return;
  }
  m_pBuffer = (VulkanVertexBuffer*)m_pRenderer->CreateVertexBuffer( (GR::u32)Vertices.size() / 2, m_VertexFormat, XVertexBuffer::PT_LINE );
}



void VulkanLineCache::GrowCache()
{
...
void VulkanLineCache::FlushCache()
{
  if ( m_pBuffer == NULL )
  {
    return;
...
void VulkanLineCache::DrawPart( int StartPrimitive, int PrimitiveCount )
{
...
void VulkanLineCache::TransformChanged( XRenderer::eTransformType TransformType )
{
