...
XMesh* CLoadMD3::ImportMD3( const char* strFileName )
{
...
void CLoadMD3::ConvertDataStructures( tMd3MeshInfo meshHeader)
{
  ...
  */
  ...
  for(i=0; i < meshHeader.numTriangles; i++)
  {
    ...
    size_t  iFace = m_pLoadingObject->AddFace( Mesh::Face( iCurrentVertexOffset + m_pTriangles[i].vertexIndices[1], 
    ...
    */
    ...
    m_pLoadingObject->m_Faces[iFace].m_TextureX[1] = m_pTexCoords[m_pTriangles[i].vertexIndices[1]].textureCoord[0];
    m_pLoadingObject->m_Faces[iFace].m_TextureY[1] = m_pTexCoords[m_pTriangles[i].vertexIndices[1]].textureCoord[1];
    m_pLoadingObject->m_Faces[iFace].m_TextureX[0] = m_pTexCoords[m_pTriangles[i].vertexIndices[0]].textureCoord[0];
    m_pLoadingObject->m_Faces[iFace].m_TextureY[0] = m_pTexCoords[m_pTriangles[i].vertexIndices[0]].textureCoord[1];
    m_pLoadingObject->m_Faces[iFace].m_TextureX[2] = m_pTexCoords[m_pTriangles[i].vertexIndices[2]].textureCoord[0];
    m_pLoadingObject->m_Faces[iFace].m_TextureY[2] = m_pTexCoords[m_pTriangles[i].vertexIndices[2]].textureCoord[1];
