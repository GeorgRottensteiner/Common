#ifndef XTREME_OPENGLSHADER_LINECACHE_H
#define XTREME_OPENGLSHADER_LINECACHE_H
...
class LineCache
{
  ...
  public:
    ...
    LineCache( OpenGLShaderRenderClass* pRenderer, GR::u32 VertexFormat );
    ~LineCache();
...
#endif // XTREME_OPENGLSHADER_LINECACHE_H