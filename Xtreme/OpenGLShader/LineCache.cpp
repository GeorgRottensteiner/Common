...
void LineCache::VertexEntry::SetColor( GR::u32 Color )
{
  Diffuse = Color;
}
...
LineCache::LineCache( OpenGLShaderRenderClass* pRenderer, GR::u32 VertexFormat ) :
  m_pBuffer( NULL ),
...
void LineCache::AddEntry( XTexture* pTexture, const GR::tVector& Pos1, const GR::tVector& Pos2, GR::u32 Color,
...
void LineCache::AddEntry( XTexture* pTexture,
...
void LineCache::EnsureBuffer()
{
  if ( m_pBuffer != NULL )
  {
    return;
  }
  m_pBuffer = (OpenGLShaderVertexBuffer*)m_pRenderer->CreateVertexBuffer( (GR::u32)Vertices.size() / 2, m_VertexFormat, XVertexBuffer::PT_LINE );
}



void LineCache::GrowCache()
{
...
void LineCache::DrawPart( int StartPrimitive, int PrimitiveCount )
{
...
void LineCache::TransformChanged( XRenderer::eTransformType TransformType )
{
