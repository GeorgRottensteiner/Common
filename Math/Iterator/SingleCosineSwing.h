#ifndef SINGLE_COSINE_SWING_ITERATOR_H
#define SINGLE_COSINE_SWING_ITERATOR_H
...
namespace math
{
  namespace Iterator
  {
    class SingleCosineSwing : public IMathIterator<float>
    {
      ...
      public:
        ...
        SingleCosineSwing( GR::f32 Radius, GR::f32 Duration = 1.0f, GR::f32 Offset = 0.0f )
        {
        ...
        GR::f32 Value()
        {
          return (GR::f32)( m_Offset + m_Radius * cos( m_SinusValue * 180.0f / m_IteratorLength * 3.1415926f / 180.0f ) );
        }
